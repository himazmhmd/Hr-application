...
<html lang="en">
	<head>
		...
		<title>Qatar Id renewal requests</title>
		...
		<div class="h-100">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					>
						<h1 class="content-toolbar-title">Qatar Id renewal requests</h1>
					</div>
					<main class="content">
						<div class="row">
							<div class="col-lg-12">
								<div class="content-card shadow-sm position-relative">
									<h5 class="fw-bold mb-3">Qatar Id renewal requests List</h5>
